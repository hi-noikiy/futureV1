 ...
 *
 */
public class TestBasedOnFutureKLineAndClosedByProfitStrategy2 {
	private static Logger log = Logger.getLogger(TestBasedOnFutureKLineAndClosedByProfitStrategy2.class);
